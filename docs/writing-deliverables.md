...
Applicants divide their project into **three milestones** — MVP, Testnet, and Mainnet. Funding is released in **four tranches** tied to these milestones:
...
Your job is to define concrete deliverables under each milestone that a reviewer can verify without ambiguity.
...
### 2. MVP must include a Stellar/Soroban technical component

Your first milestone is your proof of intent. Reviewers look at MVP deliverables closely. They must show that your team can interact with Stellar or Soroban technically — not just produce a design doc.

**Good MVP deliverables:**
...
**Bad MVP deliverables:**
- "Research and planning phase"
- "Write technical specification"
- "Set up development environment"

### 3. Each milestone should build visibly on the last

Reviewers should see a clear progression: working core, then testable product, then production-ready launch. Avoid deliverables that jump ahead or repeat previous work.

**Good progression:**
- MVP: Soroban contract deployed to testnet with core function, basic UI with wallet connection
- Testnet: Full feature set on testnet, shared with community on Discord for feedback
- Mainnet: Mainnet deployment with onboarding flow, documentation, and usage dashboard

**Bad progression:**
- MVP: "Research and planning"
- Testnet: "Continue development"
- Mainnet: "Launch"

### 4. Deliverables should be scoped to the milestone timeline

Each milestone represents roughly 4-6 weeks of work. If a single deliverable would take 3 months, it's too big — break it down. If you have 10 deliverables for a single milestone, consolidate.
...
This is the technical heart of your project. It goes in the MVP milestone.
...
### Step 4: Assign 2-4 deliverables per milestone

Keep each milestone focused. Two to four deliverables per milestone is the sweet spot. Each should be independently verifiable.
...
|-----------|---------|-------------|
| **MVP** | **T1 (20%)** | 1. Working prototype connecting to anchor's SEP-31 API with a test transaction. GitHub repo link. 2. MVP mobile app with wallet creation, KYC flow stub, and anchor deposit initiation. 3. End-to-end transaction on testnet from USD deposit to PHP payout (screen recording). |
| **Testnet** | **T2 (30%)** | 1. Full-featured testnet app with KYC, transaction history, and fee display. 2. Testable build shared in Stellar Discord for community feedback. 3. Integration test suite covering anchor API edge cases. |
| **Mainnet** | **T3 (40%)** | 1. Mainnet deployment with live anchor connection. 2. Onboarding flow with in-app tutorial and FAQ. 3. Public landing page with documentation. 4. Dashboard showing transaction volume and user count. |
...
| Milestone | Tranche | Deliverables |
|-----------|---------|-------------|
| **MVP** | **T1 (20%)** | 1. Core lending-pool Soroban contract deployed to testnet with deposit/withdraw functions and passing tests. Contract address + GitHub repo. 2. Protocol design doc with interest rate model and liquidation logic. 3. Basic frontend for deposit, borrow, and repay operations. |
| **Testnet** | **T2 (30%)** | 1. Complete testnet deployment with all contracts, frontend, and SDK. 2. Security review (internal or external audit report). 3. Testable URL shared with community, feedback incorporated. |
| **Mainnet** | **T3 (40%)** | 1. Mainnet deployment of all contracts. 2. Production frontend with onboarding, documentation, and risk disclaimers. 3. SDK published to npm. 4. Liquidity bootstrap plan and initial pool metrics. |
...
| No Stellar component in MVP | Fails the proof-of-intent check. Likely rejected at prescreen. |
...
| Design docs as the only MVP deliverable | Reviewers need to see code interacting with Stellar, not just plans. |

---

## Checklist Before You Submit

- [ ] MVP includes a technical deliverable that interacts with Stellar or Soroban
- [ ] Each milestone has 2-4 concrete, verifiable deliverables
- [ ] Each deliverable states how a reviewer can confirm it's done
- [ ] Milestones show clear progression (core working -> testable -> live)
...
- [ ] Budget per milestone aligns with the work described
- [ ] Timeline per milestone is realistic (4-6 weeks each)
